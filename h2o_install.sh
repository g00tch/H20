...
CONFIGFOLDER='/root/.h2o'
COIN_DAEMON='h2od'
COIN_CLI='h2o-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/g00tch/H20/releases/download/V1.2.1.5/H2O.zip'
...
function important_information() {
 ...
 echo -e "${GREEN}h2o-cli masternode status${NC}"
 echo -e "${GREEN}h2o-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always expected gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}h2o: B6q3pMccExvyejrGrB5tRLK12dhmuRBTFC${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
